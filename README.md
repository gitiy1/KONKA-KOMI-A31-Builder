...
Run `ImmortalWrt 24.10 6.6 KOMI A31` manually from the Actions tab. The workflow caches `/workdir/.ccache` and uploads `.itb`, `.bin`, manifest, buildinfo, and checksums.
